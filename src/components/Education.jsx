...
const Education = () => {
  ...
  const education = [
    {
      institution: "MIT ACSC Alandi",
      degree: "Bachelor of Computer Applications (BCA)",
      field: "Computer Applications (Science)",
      period: "2023 – 2026",
    },
    {
      institution: "C.S.R College",
      degree: "HSC (12th)",
      field: "Science",
      period: "2022 – 2023",
    },
...
const achievements = [
  "Built multiple backend-focused academic and personal projects using Python and Django",
  "Hands-on experience with REST APIs, authentication, and database-driven applications",
  "Actively preparing for backend developer roles through practical project-based learning"
];
