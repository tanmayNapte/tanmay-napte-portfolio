...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const templateParams = {
      ...
      to_email: 'tanmaynapte232@gmail.com',
      date_time: formattedDate,
      user_login: 'tanmaynapte'
    };
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:tanmaynapte232@gmail.com" className="text-muted hover:text-light transition-colors">
                    tanmaynapte232@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/tanmayNapte" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/tanmay-napte-950b8428b/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
